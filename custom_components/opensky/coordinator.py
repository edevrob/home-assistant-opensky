...
from .api import OpenSkyApiClient, OpenSkyApiError, StateVector
from .const import (
    ATTR_ALTITUDE,
    ATTR_CALLSIGN,
    ATTR_ICAO24,
...
class OpenSkyDataUpdateCoordinator(DataUpdateCoordinator[int]):
    ...
    def __init__(
        self, hass: HomeAssistant, config_entry: ConfigEntry, opensky: OpenSkyApiClient
    ) -> None:
        ...
        self._bounding_box = OpenSkyApiClient.get_bounding_box(
